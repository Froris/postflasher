      ...
      >
            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class='subtitle'>
                  Last updated <div className='question'>April 10, 2023</div>
                </span>
              </span>
            </strong>
          </span>
            ...
            <span style={{ color: 'rgb(89, 89, 89)', fontSize: 15 }}>
              <span data-custom-class='body_text'>
                ...
                <div className='question'>
                  PostFlasher (<strong>Company</strong> ', '<strong>we</strong>
            ...
            <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
              <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class='body_text'>
                  ...
                  <div className='question'>
                    <a
                      href='https://postflasher0.netlify.app/'
                      target='_blank'
                      data-custom-class='link'
                      rel='noreferrer'
                    >
                      https://postflasher0.netlify.app/
                    </a>
                  </div>
                  <span style={{ fontSize: 15 }}>
                    <span style={{ color: 'rgb(89, 89, 89)' }}>
        ...
        <div>
            ...
            <span style={{ fontSize: 15 }}>
              <span style={{ color: 'rgb(127, 127, 127)' }}>
                <span data-custom-class='body_text'>
                  ...
                  <div className='question'>postflasher@gmail.com</div>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class='body_text'>
                ...
                <div className='block-component' />
                <div className='question'>PostFlasher</div>
          ...
          <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class='body_text'>
                ...
                <div className='block-component' />
                organisational
                <div className='else-block' /> and technical processes and
                ...
                unauthorised
                <div className='else-block' /> third parties will not be able to
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            <a
              data-custom-class='link'
              href='https://app.termly.io/notify/2604e7e0-eba4-486b-8777-11411672f20c'
            ...
            <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
              <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class='body_text'>
                  ...
                  <div className='block-component' />'
                  <div className='else-block' /> below.
                </span>
              </span>
            </span>
          </div>
              ...
              <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class='body_text'>
                  ...
                  <span style={{ color: 'rgb(89, 89, 89)' }}>
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class='body_text'>
                        <div className='block-component' /> social media
                        platforms,
                        <div className='statement-end-if-in-editor' />
                      </span>
                    </span>
                  ...
                  intent data (or user <div className='block-component' />
                  behaviour
                  <div className='else-block' /> data), Internet Protocol (IP)
                  ...
                  <span style={{ color: 'rgb(89, 89, 89)' }}>
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class='body_text'>
                        ...
                        <div className='block-component' /> Facebook or
                        Twitter), we receive personal information about you such
                        as your name, email address, and gender. Any personal
                        information that we collect from your social media
                            ...
                            >
                              <span data-custom-class='body_text'>
                                <strong>
                                  ...
                                  fulfil
                                  <div className='else-block' /> and manage your
                                  orders.&nbsp;
                                </strong>
